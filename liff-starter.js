...
window.onload = function() {
    ...
    const defaultLiffId = "1655538958-713ydKpq";   // change the default LIFF value if you are not using a node server
...
function initializeApp() {
    ...
    if (liff.isLoggedIn()) {
        ...
        liff.getProfile()
        .then(profile => {
            console.log("yayay2 : "+profile.displayName);
            namaLine = profile.displayName;
            console.log("yayay3 : "+namaLine);
        ...
        document.getElementById('welcome').innerHTML = "Selamat Datang, silahkan login terlebih dahulu!AYOOO";
...
function registerButtonHandlers() {
    ...
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: 'https://testinglageh01.herokuapp.com/', // Isi dengan Endpoint URL aplikasi web Anda
            external: true
        });
    });
